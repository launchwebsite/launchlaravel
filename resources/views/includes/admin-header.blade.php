            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                <li class="dropdown">
                    {{-- <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#"
                        ...
                        <img src="/storage/admin/assets/images/flags/us_flag.jpg" alt=""
                            class="thumb-sm rounded-circle">
                    </a> --}}
                    {{-- <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"><img src="/storage/assets/images/flags/us_flag.jpg"
                                alt="" height="15" class="me-2">English</a>
                        <a class="dropdown-item" href="#"><img src="/storage/assets/images/flags/spain_flag.jpg"
                                alt="" height="15" class="me-2">Spanish</a>
                        <a class="dropdown-item" href="#"><img src="/storage/assets/images/flags/germany_flag.jpg"
                                alt="" height="15" class="me-2">German</a>
                        <a class="dropdown-item" href="#"><img src="/storage/assets/images/flags/french_flag.jpg"
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-0">
                        <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                            {{-- <div class="flex-shrink-0">
                                <img src="/storage/admin/assets/images/users/avatar-1.jpg" alt=""
