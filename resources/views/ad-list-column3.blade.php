                        ...
                        <div class="col-lg-12">
                            <div class="header-filter">
                                ...
                                <div class="filter-action">
                                    <a class='active' href='{{ route('adlist3') }}' title='Three Column'><i
                                            class="fas fa-th"></i></a>
                    ...
                    <div class="row">
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">5-Bedroom Signature Villa with Private Beach
                                            Access</a>
                                    </h5>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="/storage/images/product/08.jpg"
                                            alt="Latest smartphone for sale in Dubai">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-clipboard-check"></i>
                                        <span>recommend</span>
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Brand New Flagship Smartphone, Sealed Box, Dubai
                                            Warranty</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Purebred Persian Kitten, Vaccinated, Papers
                                            Included</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Self-Drive SUV Rental, Unlimited Mileage, Full
                                            Insurance</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="/storage/images/product/11.jpg"
                                            alt="Duplex penthouse in Downtown Dubai">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-bolt"></i>
                                        <span>trending</span>
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Duplex Penthouse with Burj Khalifa View, Fully
                                            Furnished</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">High-Performance Gaming Laptop, RTX Graphics</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Mountain Bike Rental, Perfect for Al Qudra Cycling
                                            Track</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Professional DSLR Camera Kit with Two Lenses and
                                            Bag</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Private Yacht Charter, Captain and Crew Included</a>
                                    </h5>
                                    <div class="product-meta">
                                        <span><i class="fas fa-map-marker-alt"></i>Dubai Marina, Dubai</span>
                                        <span><i class="fas fa-clock"></i>30 min ago</span>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="/storage/images/product/02.jpg"
                                            alt="Designer sneakers for sale in Dubai">
                                    </div>
                                    <div class="product-type">
                                        <span class="flat-badge sale">sale</span>
                                    </div>
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Limited Edition Designer Sneakers, Size 42, New</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="/storage/images/product/03.jpg"
                                            alt="Arabic language textbooks for sale">
                                    </div>
                                    <div class="product-type">
                                        <span class="flat-badge rent">rent</span>
                                    </div>
                                ...
                                <div class="product-content">
                                    <ol class="breadcrumb product-category">
                                        <li><i class="fas fa-tags"></i></li>
                                        <li class="breadcrumb-item"><a href="{{ route('addetails') }}">Education</a></li>
                                    </ol>
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">Complete Set of Arabic and IGCSE Study Books</a>
                                    </h5>
                                    <div class="product-meta">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                            <div class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <h5 class="product-title">
                                        <a href="{{ route('addetails') }}">65-Inch 4K Smart TV, Barely Used, Wall Mount
                                            Included</a>
                                    </h5>
                                    <div class="product-meta">
