                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <form
                                    action="{{ isset($careers) ? route('career.update', \Vinkla\Hashids\Facades\Hashids::encode($careers->CR_Id)) : route('career.store') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea id="CR_Company" name="CR_Company" placeholder="Enter Company" rows="4" class="form-control">{{ old('CR_Company', $careers->CR_Company ?? '') }}</textarea>
