                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <form action="{{ route('vendor.post-store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12">
...
$(document).ready(function () {
    ...
    // Store all subcategories when page loads
    ...
    $('#category').on('change', function () {
        ...
        // Add only selected category's subcategories
    ...
    $('#subcategory').on('change', function () {
        ...
        // Show selected subcategory attributes
        if (subcategoryId !== '') {

            $('.attribute-row[data-subcategory="' + subcategoryId + '"]')
                .show();
