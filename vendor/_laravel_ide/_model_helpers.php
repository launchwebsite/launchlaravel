...
namespace App\Models {
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property bool $LS_Status
     * @property array|null $LS_Attributes
     * @property string|null $LS_Country
     * @property string|null $LS_City
     * @property float|null $LS_Price
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereLsId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereVrId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereCtId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereScId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereLsTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereLsPrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereLsCity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereLsCountry($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereLsAttributes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereLsStatus($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing selectExpression(\Illuminate\Contracts\Database\Query\Expression|literal-string $expression, string $as)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing selectRaw(literal-string $expression)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing fromRaw(literal-string $expression, mixed $bindings)
     * @method static array createSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
     * @method static array parseSub(mixed $query)
     * @method static mixed prependDatabaseNameIfCrossDatabaseQuery(mixed $query)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing straightJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing straightJoinWhere(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string $operator, \Illuminate\Contracts\Database\Query\Expression|string $second)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing straightJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
     * @method static \Illuminate\Database\Query\JoinClause newJoinClause(string $type, \Illuminate\Contracts\Database\Query\Expression|string $table)
     * @method static \Illuminate\Database\Query\JoinLateralClause newJoinLateralClause(string $type, \Illuminate\Contracts\Database\Query\Expression|string $table)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing whereRaw(\Illuminate\Contracts\Database\Query\Expression|literal-string $sql, mixed $bindings, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing orWhereRaw(literal-string $sql, mixed $bindings)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing groupByRaw(literal-string $sql)
     ...
     * @method static array{\DateTimeInterface, \DateTimeInterface} resolveDatePeriodBounds(\DatePeriod $period)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing havingRaw(literal-string $sql, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing orHavingRaw(literal-string $sql)
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing orderBy(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, \SortDirection|"asc"|"desc" $direction)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing orderByRaw(literal-string $sql, array $bindings)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing reorder(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null $column, \SortDirection|"asc"|"desc" $direction)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Listing>|Listing fetchUsing(mixed ...$fetchUsing)
     * @method static bool isQueryable(mixed $value)
