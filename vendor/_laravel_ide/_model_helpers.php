...
<<<<<<< HEAD
	 ...
	 * @property \Illuminate\Support\Carbon|null $updated_at
	 * @property \Illuminate\Support\Carbon|null $created_at
	 * @property string|null $CA_Resume
	 * @property string $CA_JobType
	 * @property string $CA_Phone
	 * @property string $CA_Email
	 * @property string $CA_Name
	 * @property int $CR_Id
	 * @property int $CA_Id
	 * @property-read \App\Models\Career $career
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereCaId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereCrId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereCaName($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereCaEmail($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereCaPhone($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereCaJobtype($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereCaResume($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereCreatedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereUpdatedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication newModelQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication newQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication query()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication select(mixed $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication selectSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication selectExpression(\Illuminate\Contracts\Database\Query\Expression|literal-string $expression, string $as)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication selectRaw(literal-string $expression)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication fromSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication fromRaw(literal-string $expression, mixed $bindings)
	 * @method static array createSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
	 * @method static array parseSub(mixed $query)
	 * @method static mixed prependDatabaseNameIfCrossDatabaseQuery(mixed $query)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication addSelect(mixed $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication selectVectorDistance(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Support\Collection<int, float>|\Illuminate\Contracts\Support\Arrayable|array<int, float>|string $vector, string|null $as)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication distinct()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication from(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $table, string|null $as)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication useIndex(string $index)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication forceIndex(string $index)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication ignoreIndex(string $index)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication join(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second, string $type, bool $where)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication joinLateral(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication leftJoinLateral(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication leftJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication rightJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication crossJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string|null $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication crossJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication straightJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
	 ...
	 * @method static \Illuminate\Database\Query\JoinClause newJoinClause(string $type, \Illuminate\Contracts\Database\Query\Expression|string $table)
	 * @method static \Illuminate\Database\Query\JoinLateralClause newJoinLateralClause(string $type, \Illuminate\Contracts\Database\Query\Expression|string $table)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication mergeWheres(array $wheres, array $bindings)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication where(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication addArrayOfWheres(array $column, string $boolean, string $method)
=======
...
>>>>>>> feature/vehicles-listing
	 ...
	 * @method static bool isBitwiseOperator(string $operator)
<<<<<<< HEAD
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhere(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNot(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNot(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereColumn(\Illuminate\Contracts\Database\Query\Expression|string|array $first, string|null $operator, string|null $second, string|null $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereColumn(\Illuminate\Contracts\Database\Query\Expression|string|array $first, string|null $operator, string|null $second)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereRaw(\Illuminate\Contracts\Database\Query\Expression|literal-string $sql, mixed $bindings, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereRaw(literal-string $sql, mixed $bindings)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNotLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNotLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNullSafeEquals(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNullSafeEquals(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNotIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNotIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNull(string|array|\Illuminate\Contracts\Database\Query\Expression $columns, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNull(string|array|\Illuminate\Contracts\Database\Query\Expression $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNotNull(string|array|\Illuminate\Contracts\Database\Query\Expression $columns, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereBetween(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereBetween(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNotBetween(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNotBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNotBetween(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNotBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereValueBetween(mixed $value, array{\Illuminate\Contracts\Database\Query\Expression|string, \Illuminate\Contracts\Database\Query\Expression|string} $columns, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereValueBetween(mixed $value, array{\Illuminate\Contracts\Database\Query\Expression|string, \Illuminate\Contracts\Database\Query\Expression|string} $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereValueNotBetween(mixed $value, array{\Illuminate\Contracts\Database\Query\Expression|string, \Illuminate\Contracts\Database\Query\Expression|string} $columns, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereValueNotBetween(mixed $value, array{\Illuminate\Contracts\Database\Query\Expression|string, \Illuminate\Contracts\Database\Query\Expression|string} $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNotNull(\Illuminate\Contracts\Database\Query\Expression|string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereDate(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereDate(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereTime(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereTime(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereDay(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereDay(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereMonth(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereMonth(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereYear(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereYear(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication addDateBasedWhere(string $type, \Illuminate\Contracts\Database\Query\Expression|string $column, string $operator, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNested(string $boolean)
	 * @method static \Illuminate\Database\Query\Builder forNestedWhere()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication addNestedWhereQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereSub(\Illuminate\Contracts\Database\Query\Expression|string $column, string $operator, \Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNotExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNotExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication addWhereExistsQuery(string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereRowValues(array $columns, string $operator, array $values, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereRowValues(array $columns, string $operator, array $values)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereJsonContains(string $column, mixed $value, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereJsonContains(string $column, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereJsonDoesntContain(string $column, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereJsonDoesntContain(string $column, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereJsonOverlaps(string $column, mixed $value, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereJsonOverlaps(string $column, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereJsonDoesntOverlap(string $column, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereJsonDoesntOverlap(string $column, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereJsonContainsKey(string $column, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereJsonContainsKey(string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereJsonDoesntContainKey(string $column, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereJsonDoesntContainKey(string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereJsonLength(string $column, mixed $operator, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereJsonLength(string $column, mixed $operator, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication dynamicWhere(string $method, array $parameters)
	 * @method static void addDynamic(string $segment, string $connector, array $parameters, int $index)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereFullText(string|string[] $columns, string $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereFullText(string|string[] $columns, string $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereAll(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereAll(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereAny(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereAny(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNone(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNone(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication groupBy(array|\Illuminate\Contracts\Database\Query\Expression|string ...$groups)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication groupByRaw(literal-string $sql)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication havingNested(string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication addNestedHavingQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication havingNull(array|string $columns, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orHavingNull(string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication havingNotNull(array|string $columns, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orHavingNotNull(string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication havingBetween(string $column, string $boolean, bool $not)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication havingNotBetween(string $column, iterable $values, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orHavingBetween(string $column, iterable $values)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orHavingNotBetween(string $column, iterable $values)
	 * @method static array{\DateTimeInterface, \DateTimeInterface} resolveDatePeriodBounds(\DatePeriod $period)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication havingRaw(literal-string $sql, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orHavingRaw(literal-string $sql)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orderBy(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, \SortDirection|"asc"|"desc" $direction)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orderByDesc(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication latest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication oldest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orderByVectorDistance(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Support\Collection<int, float>|\Illuminate\Contracts\Support\Arrayable|array<int, float> $vector)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication inRandomOrder(string|int $seed)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication inOrderOf(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orderByRaw(literal-string $sql, array $bindings)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication skip(int $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication offset(int $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication take(int $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication limit(int $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication groupLimit(int $value, string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication forPage(int $page, int $perPage)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication forPageBeforeId(int $perPage, int|null $lastId, string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication forPageAfterId(int $perPage, int|null $lastId, string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication reorder(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null $column, \SortDirection|"asc"|"desc" $direction)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication reorderDesc(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null $column)
	 * @method static array removeExistingOrdersFor(string $column)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication union(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $query, bool $all)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication unionAll(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $query)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication lock(string|bool $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication lockForUpdate()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication sharedLock()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication timeout(int|null $seconds)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication beforeQuery()
	 * @method static void applyBeforeQueryCallbacks()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication afterQuery()
=======
...
>>>>>>> feature/vehicles-listing
	 ...
	 * @method static mixed runPaginationCountQuery(array<string|\Illuminate\Contracts\Database\Query\Expression> $columns)
<<<<<<< HEAD
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication cloneForPaginationCount()
=======
...
>>>>>>> feature/vehicles-listing
	 ...
	 * @method static float|int numericAggregate(string $function, array $columns)
<<<<<<< HEAD
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication setAggregate(string $function, array<\Illuminate\Contracts\Database\Query\Expression|string> $columns)
=======
...
>>>>>>> feature/vehicles-listing
	 ...
	 * @method static mixed getRawBindings()
<<<<<<< HEAD
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication setBindings(list<mixed> $bindings, "select"|"from"|"join"|"where"|"groupBy"|"having"|"order"|"union"|"unionOrder" $type)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication addBinding(mixed $value, "select"|"from"|"join"|"where"|"groupBy"|"having"|"order"|"union"|"unionOrder" $type)
	 * @method static mixed castBinding(mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication mergeBindings(self $query)
=======
...
>>>>>>> feature/vehicles-listing
	 ...
	 * @method static \Illuminate\Database\Query\Grammars\Grammar getGrammar()
<<<<<<< HEAD
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication useWritePdo()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication fetchUsing(mixed ...$fetchUsing)
	 * @method static bool isQueryable(mixed $value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication clone()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication cloneWithout()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication cloneWithoutBindings()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication dump(mixed ...$args)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication dumpRawSql()
	 * @method static void dd()
	 * @method static void ddRawSql()
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication wherePast(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNowOrPast(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWherePast(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNowOrPast(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereFuture(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereNowOrFuture(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereFuture(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereNowOrFuture(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication wherePastOrFuture(array|string $columns, string $operator, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereToday(array|string $columns, string $boolean)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereBeforeToday(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereTodayOrBefore(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereAfterToday(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereTodayOrAfter(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereToday(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereBeforeToday(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereTodayOrBefore(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereAfterToday(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication orWhereTodayOrAfter(array|string $columns)
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication whereTodayBeforeOrAfter(array|string $columns, string $operator, string $boolean)
=======
...
>>>>>>> feature/vehicles-listing
	 ...
	 * @method static \Illuminate\Support\LazyCollection orderedLazyById(int $chunkSize, string|null $column, string|null $alias, \SortDirection|bool $descending)
<<<<<<< HEAD
	 * @method static CareerApplication|null first(array|string $columns)
	 * @method static CareerApplication firstOrFail(array|string $columns, string|null $message)
	 * @method static CareerApplication sole(array|string $columns)
=======
...
>>>>>>> feature/vehicles-listing
	 ...
	 * @method static \Illuminate\Pagination\CursorPaginator cursorPaginator(\Illuminate\Support\Collection $items, int $perPage, \Illuminate\Pagination\Cursor $cursor, array $options)
<<<<<<< HEAD
	 * @method static \Illuminate\Database\Eloquent\Builder<CareerApplication>|CareerApplication tap(callable($this): mixed $callback)
=======
